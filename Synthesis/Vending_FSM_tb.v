...
module tb_vending_two_phase;
  ...
  initial begin
    ...
    // Case 1: Exact pay, vend item0 (price0=6 units=$30): $25 + $5
    insert_coin(2'b10);
    insert_coin(2'b00);
    select_item(2'd0);
    repeat(20) @(posedge clk);

    // Case 2: Overpay, vend item1 (price1=8 units=$40): $25+$25 => change $10
    insert_coin(2'b10);
    insert_coin(2'b10);
    select_item(2'd1);
    ...
    // Case 6: No-change (force bank=0) with overpay => error
    dut.change_bank = 0;
    insert_coin(2'b10);
    insert_coin(2'b10);
    select_item(2'd0);
